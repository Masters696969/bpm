...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const umdNameTop = document.getElementById('umdNameTop');
    ...
    if (umdNameTop && umdName) {
        const name = umdNameTop.textContent.trim();
                ...
                <td>
                    <div class="emp-info">
                        ...
                        <div class="emp-details" style="margin-left: 12px;">
                            ...
                            <span style="font-size: 11px; color: var(--text-tertiary); text-transform: uppercase; letter-spacing: 0.05em;">Submitted Proposal</span>
                        </div>
                    </div>
                </td>
                <td>
        ...
        try {
            ...
            try {
                ...
                if (res.success) {
                    ...
                    document.getElementById('batchReviewSummary').textContent = `Total of ${res.data.length} employees included in this compensation proposal.`;
                } else {
