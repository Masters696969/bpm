...
<head>
  ...
  <link rel="stylesheet" href="../../css/compeintake.css?v=1.2">
...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer">
      <div class="user-profile">
        ...
        <div class="user-info">
          <span class="user-name" id="umdNameTop"><?php echo htmlspecialchars($_SESSION['username'] ?? 'Admin'); ?></span>
          <span class="user-role" id="umdRoleTop"><?php echo htmlspecialchars($_SESSION['user_role'] ?? 'Administrator'); ?></span>
        </div>
        ...
        <div class="user-menu-dropdown" id="userMenuDropdown">
          <div class="umd-header">
            ...
            <div class="umd-info">
              ...
              <span class="umd-role" id="umdRole"><?php echo htmlspecialchars($_SESSION['user_role'] ?? 'Administrator'); ?></span>
            </div>
          </div>
      ...
      <div class="content-card">
        ...
        <div class="dispatch-table-container">
          <table class="dispatch-table" id="intakeTable">
            <thead>
              <tr>
                <th style="width: 250px;">Cycle Name</th>
                <th style="width: 200px;">Position Overview</th>
                <th style="width: 150px; text-align: center;">Employees</th>
                <th style="width: 180px; text-align: center;">Submitted At</th>
  ...
  <script src="../../js/compeintake.js"></script>
  <script>
