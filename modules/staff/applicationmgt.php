...
<head>
  ...
  <link rel="stylesheet" href="../../css/staff_applicationmgt.css?v=<?php echo time(); ?>">
...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      <div class="nav-section">
        ...
        <a href="applicationmgt.php" class="nav-item active">
  ...
  <script src="../../js/staff_applicationmgt.js?v=<?php echo time(); ?>"></script>
  <script>
    if (window.lucide) {
        lucide.createIcons();
    } else {
