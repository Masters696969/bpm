...
$adminLabel = $_SESSION['user_role'] ?? 'Administrator';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Leave Approval | <?php echo htmlspecialchars($adminLabel); ?></title>
    ...
    <div class="page-shell">
        <div class="page-header">
            <div class="page-title-wrap">
                ...
                <p>Review officer-endorsed employee leave applications for final admin decision.</p>
            </div>
...
?>
        ...
        <section class="panel">
            <div class="tabs">
                ...
                <button class="tab-btn" data-tab="APPROVED_BY_OFFICER">For Admin Review</button>
    ...
    <div class="modal">
        <div class="modal-header">
            <div>
                ...
                <p>Review officer-endorsed leave application before final admin approval.</p>
            </div>
        ...
        <div class="modal-body">
            ...
            <div style="display:grid; gap:18px;">
                ...
                <div class="info-card">
                    <h3><i data-lucide="sticky-note"></i> Admin Remarks</h3>
