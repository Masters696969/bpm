...
$deptName = $_SESSION['department_name'] ?? 'Admin';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Claims Decision | <?php echo htmlspecialchars($deptName); ?></title>
    ...
    <div class="page-shell">
        <div class="page-header">
            <div class="page-title-wrap">
                <h1><i data-lucide="receipt-text"></i> Claims Decision</h1>
                <p>Admin review and final decision of employee reimbursement claims.</p>
            </div>
        ...
        <section class="panel">
            <div class="tabs">
                <button class="tab-btn active" data-status="PENDING">For Decision</button>
...
<div class="modal-overlay" id="claimModal">
    <div class="modal">
        <div class="modal-header">
            <div>
                <h2>Claim Decision Details</h2>
                <p>Review and decide on employee reimbursement request.</p>
            </div>
        ...
        <div class="modal-body">
            ...
            <div style="display:grid; gap:18px;">
                ...
                <div class="info-card">
                    <h3><i data-lucide="sticky-note"></i> Submission Notes</h3>
                    <div class="modal-note-box" id="mOfficerNotes">No submission notes.</div>
                </div>

                <div class="info-card">
                    <h3><i data-lucide="notebook-pen"></i> Admin Remarks</h3>
                    <textarea class="notes-textarea" id="hrRemarks" placeholder="Enter admin remarks..."></textarea>
                </div>
            </div>
        </div>
