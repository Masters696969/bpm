...
<body>
      ...
      <div class="nav-section">
        ...
        <div class="nav-item-group">
          <button class="nav-item has-submenu" data-module="ess">
            <div class="nav-item-content active">
        ...
        <div class="resume-container">
            <div class="resume-header">
                ...
                <div class="header-status" style="display: flex; gap: 10px; align-items: center;">
                    ...
                    <button type="button" class="btn btn-save" id="btnRequestEdit" style="background-color: var(--brand-blue);">
  ...
  <script src="../../js/hr1informationmanagement.js?v=1.1"></script>
  <script>
    lucide.createIcons();
  </script>
