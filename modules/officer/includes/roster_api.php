...
function minutes_to_hours_float(int $minutes): float
{
...
function format_break_hours_label(int $minutes): string
{
    if ($minutes <= 0) {
        return 'No break';
    }

    return format_hours_and_minutes_label($minutes) . ' break';
}

function format_grace_hours_label(int $minutes): string
{
    if ($minutes <= 0) {
        return '0 hr grace';
    }

    return format_hours_and_minutes_label($minutes) . ' grace';
}
